 ...
 * @version 1.3.3
 */
public class DynamicContextReceptacle {
    
    /** Creates a new instance of ParallelReceptacle */
    public DynamicContextReceptacle() {
    }
    ...
    public static void main(String[] args) {
        ...
        IUnknown pCalcIUnk = (IUnknown) pIOCM.createInstance("Samples.CalculatorComponent.CalculatorDynamicContext", "Calculator");
        ...
        for(int j=0; j<10; j++){
            pAdderIUnk = (IUnknown) pIOCM.createInstance("Samples.AdderComponent.AdderContextTwo", "Adder "+j);
            pILife =  (ILifeCycle) pAdderIUnk.QueryInterface("OpenCOM.ILifeCycle");
            pILife.startup(pIOCM);
            long ConnID3 = runtime.connect(pCalcIUnk, pAdderIUnk, "Samples.AdderComponent.IOutput");
        }
