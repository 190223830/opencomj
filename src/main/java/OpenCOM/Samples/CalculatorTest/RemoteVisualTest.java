...
/**
 * Visualise the basic operations of the OpenCOM runtime. Visualisation performed on
 * a remote server.
 *
 * @author  Paul Grace
 * @version 1.3.5
...
public class RemoteVisualTest {
    ...
    public static void main(String[] args) {
        ...
        long ConnID = runtime.connect(runtime, pRemoteClient, "OpenCOM.IKernelDeliver");
