...
package OpenCOM.Samples.CalculatorTest;
import OpenCOM.*;
import Samples.AdderComponent.*;
import Samples.SubtractComponent.*;
import Samples.CalculatorComponent.*;
/**
 * This example test program illustrates how sequential receptacles execute. In this case, 11 adders
 * are connected to the calculator. The for loop in the calc component illustrates how to invoke a multi-receptacle in
 * sequence.
 * 
 * @author  Paul Grace
 * @version 1.3.5
 */
public class SequentialReceptacle {
    
    /** Creates a new instance of ParallelReceptacle */
    public SequentialReceptacle() {
    }
    ...
    public static void main(String[] args) {
        ...
        IUnknown pCalcIUnk = (IUnknown) pIOCM.createInstance("Samples.CalculatorComponent.CalculatorSequential", "Calculator");
        ...
        pICalc.display("MultiRecp -- Sequential Test");
    }
