...
/**
 * Calculator component supporting arithmetic plug-in components. Includes a parallel receptacle.
 * That is all connections to a receptacle are invoked concurrently.
 * @author  Paul Grace
 * @version 1.3.5
 */

public class CalculatorParallel extends OpenCOMComponent implements ICalculator, IConnections, ILifeCycle, IUnknown, IMetaInterface {
    
    /**
     * Requires Interface of type IOutput. N anonymous components connect on this interface, and all
     * of the them will be invoked at the same time.
     */
    ...
    public CalculatorParallel(IUnknown binder) {
        super(binder);
	m_PSR_IOutput = new OCM_MultiReceptacleParallel<IOutput>(IOutput.class);
    ...
    public String display(String message) {
       ...
       /*
        * Perform a parallel invocation. Identical to single receptacle call.
        */
