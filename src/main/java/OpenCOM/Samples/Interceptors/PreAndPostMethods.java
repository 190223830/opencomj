...
package OpenCOM.Samples.Interceptors;
import OpenCOM.*;
import java.util.*;
/**
...
public class PreAndPostMethods {
    ...
    /**
     * Check that the rules defined on the receptacle requirements are being met
     * by the connected interface
     */
    ...
    public int Pre1(String method, Object[] args){
     ...
     public int Post0(String method, Object result, Object[] args, Exception e){
        System.out.println(" Post Intercepting Method : "+ method);
        return (Integer) result;
    }
     
      public String Post1(String method, Object result, Object[] args, Exception e){
          if(e!=null){
            e.printStackTrace();
            return (String) args[0];
          }
        String decrypted = decode((String) result, 12);
        return decrypted;
    }
