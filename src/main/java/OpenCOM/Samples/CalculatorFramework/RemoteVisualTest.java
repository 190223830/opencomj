...
package OpenCOM.Samples.CalculatorFramework;
import OpenCOM.*;
...
import java.io.*;
/**
 * Visualises a component framework after it has been deployed. This sends the information
 * to a remote server which performs the visualisation.
 *
 * @author  Paul Grace
 * @version 1.3.5
 */
public class RemoteVisualTest {
    
    public static ICalculator pICalc = null;
    
    /** Creates a new instance of TestProgram */
    public RemoteVisualTest() {
    }
    ...
    public static void main(String[] args) {
        ...
        IUnknown pRemoteClient = (IUnknown ) pIOCM.createInstance("OpenCOM.Visualisation.VisualiseClientComponent", "visClient");
        ILifeCycle pILife =  (ILifeCycle) pRemoteClient.QueryInterface("OpenCOM.ILifeCycle");
        pILife.startup(pIOCM);
        
        long ConnID = runtime.connect(runtime, pRemoteClient, "OpenCOM.IDeliver");
        ...
        pILife =  (ILifeCycle) pCFIUnk.QueryInterface("OpenCOM.ILifeCycle");
        pILife.startup(pIOCM);
