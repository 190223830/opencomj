...
public class TestProgram {
    ...
    public static void main(String[] args) {
        ...
        IUnknown pCFIUnk = (IUnknown) pIOCM.createInstance("Samples.CalculatorFramework.CalculatorFramework", "Framework");
        ...
        IUnknown pAcceptIUnk = (IUnknown) pIOCM.createInstance("Samples.AcceptComponent.Accept", "Accept");
	...
	int val3 = pCF.get_exposed_interfaces(ppIntfs);
        ...
        pCF.init_arch_transaction();
        System.out.println("Finish Final Reconfiguration");
