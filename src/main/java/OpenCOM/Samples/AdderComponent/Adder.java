...
/**
 * Simple component offering methods to add integers and receive messages. This has the
 * incorrect implementation of the add operation, which is corrected in the interception
 * test programs, and distributed framework test.
 *
 * @author  Paul Grace
 * @version 1.3.5
 */
